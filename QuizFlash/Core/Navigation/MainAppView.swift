...
//  - The activation handler is gated on the floating tab-bar visibility so that phantom UIKit
...
struct MainAppView: View {
    ...
    /// Resolves whether the bottom chrome should remain structurally present for layout.
    ///
    /// Decision table:
