...
struct MathWebView: UIViewRepresentable {
    ...
    private func buildHTML() -> String {
        ...
        // HTML-encode & then apply markdown/code passes
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            /* Block math: horizontally scrollable, no scrollbar chrome */
            .katex-display {
                margin: 0.6em 0;
                overflow-x: auto;
            ...
            /* KaTeX error: show as regular text, not red markup */
            .katex-error {
        ...
        <script>
        // ── Extra macros (shorthand aliases) ────────────────────────────────
        const extraMacros = {
            "\\\\thinspace":    "\\\\,",
            "\\\\negthinspace": "\\\\!",
            "\\\\medspace":     "\\\\:",
        ...
        // First report: wait for KaTeX fonts to load + layout to settle
        setTimeout(reportHeight, 80);
        setTimeout(reportHeight, 300);   // second pass catches late layout shifts
